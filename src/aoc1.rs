...
//! a vacation at a nice resort on a tropical island. Surely,
...
//! find fifty of these coins by the time you arrive so you can pay
...
//! entries that sum to 2020; what do you get if you multiply them
//! together?
//!
